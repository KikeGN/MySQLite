...
/**
 * Created by quiqu on 09/10/2017.
 */
...
public class DAOContactos {
    ...
    public DAOContactos(Context contexto){
        ...
        this._midb = new MiSQLiteOpenHelper(contexto).getWritableDatabase();
    }
    ...
    public long insert(Contacto c){
        ...
        cv.put(MiSQLiteOpenHelper.COLUMNS_CONTACTOS[1],c.getNombre());
        cv.put(MiSQLiteOpenHelper.COLUMNS_CONTACTOS[2],c.getCorreo_electronico());
        cv.put(MiSQLiteOpenHelper.COLUMNS_CONTACTOS[3],c.getTwitter());
        cv.put(MiSQLiteOpenHelper.COLUMNS_CONTACTOS[4],c.getTelefono());
        cv.put(MiSQLiteOpenHelper.COLUMNS_CONTACTOS[5],c.getFecha_nacimiento());
    ...
    public List<Contacto> getAll(){
        ...
        Cursor c = _midb.query(MiSQLiteOpenHelper.TABLE_CONTACTOS_NAME,
                MiSQLiteOpenHelper.COLUMNS_CONTACTOS,
                null,
                null,
                null,
                null,
                MiSQLiteOpenHelper.COLUMNS_CONTACTOS[1]);
        ...
        if (c.moveToFirst()) {
            ...
            do {
                ...
                ctc.setId(
                        c.getInt(
                                c.getColumnIndex(
                                        MiSQLiteOpenHelper.COLUMNS_CONTACTOS[0])
                        )
                );
